---
name: create-investment-memo
description: Create an investment overview of a company. 
---

Create an Investment report (`notes/<company>/report_<company>_<date>.md`) with the following sections:
